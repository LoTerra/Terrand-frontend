...
export default function Hero() {
    ...
    let animatedHands = useSpring({
        loop: { reverse: true },
        delay: 100,
        from:{y:Math.floor(Math.random() * -20),x:Math.floor(Math.random() * 20)},
        to:{y:Math.floor(Math.random() * 10),x:Math.floor(Math.random() * 10)},
        config: { mass: 10, tension: 300, friction: 100, precision: 0.00005 }
    })

    let animatedElipse_1 = useSpring({
        loop: { reverse: true },
        delay: 100,
        from:{rx:124},
        to:{rx:150},
    ...
    let animatedElipse_2 = useSpring({
        loop: { reverse: true },
        delay: 100,
        from:{rx:61},
        to:{rx:85},
    ...
    return (
        <animated.svg  width="100%" height="auto" viewBox="0 0 1169 700" fill="none" xmlns="http://www.w3.org/2000/svg" style={start}>
        ...
        <animated.ellipse style={animatedElipse_1} cx="627" cy="556.5" rx="124" ry="32.5" fill="#893976" fillOpacity="0.26"/>
        <animated.ellipse style={animatedElipse_2} cx="626" cy="553" rx="61" ry="25" fill="#893976" fillOpacity="0.26"/>
        ...
        <animated.path style={animatedHands} d="M418.789 458.72C415.514 470.483 416.795 489.476 417.846 497.503L394.83 496.833L388.711 456.084C396.97 421.759 414.11 404.734 421.648 400.512C438.071 410.075 422.882 444.018 418.789 458.72Z" fill="#C4C4C4"/>
        <animated.path style={animatedHands} d="M418.789 458.72C415.514 470.483 416.795 489.476 417.846 497.503L394.83 496.833L388.711 456.084C396.97 421.759 414.11 404.734 421.648 400.512C438.071 410.075 422.882 444.018 418.789 458.72Z" fill="url(#paint2_linear)"/>
        <animated.path style={animatedHands} d="M397.65 428.011C391.461 450.239 397.296 474.982 400.987 484.576L369.382 475.776C370.064 450.477 374.565 394.614 387.114 373.558C402.799 347.238 414.185 368.621 412.896 373.252L397.65 428.011Z" fill="#C4C4C4"/>
        <animated.path style={animatedHands} d="M397.65 428.011C391.461 450.239 397.296 474.982 400.987 484.576L369.382 475.776C370.064 450.477 374.565 394.614 387.114 373.558C402.799 347.238 414.185 368.621 412.896 373.252L397.65 428.011Z" fill="url(#paint3_linear)"/>
        <animated.path style={animatedHands} d="M387.215 354.376C384.795 365.578 378.826 431.252 376.144 462.69L352.99 456.243C349.482 441.96 346.556 404.08 362.918 366.821C379.279 329.563 385.933 343 387.215 354.376Z" fill="#C4C4C4"/>
        <animated.path style={animatedHands} d="M387.215 354.376C384.795 365.578 378.826 431.252 376.144 462.69L352.99 456.243C349.482 441.96 346.556 404.08 362.918 366.821C379.279 329.563 385.933 343 387.215 354.376Z" fill="url(#paint4_linear)"/>
        <animated.path style={animatedHands} d="M559.395 595.748C554.934 611.77 529.812 608.509 517.809 604.876C460.498 593.51 379.8 520.795 346.615 485.859C302.937 439.867 340.561 373.193 364.833 345.604C380.512 355.958 375.004 376.878 370.29 386.044C361.586 405.476 359.196 430.815 359.09 441.056C401.183 504.57 444.502 504.214 460.899 496.097C458.91 455.75 462.338 413.419 475.277 420.264C488.215 427.11 494.096 457.064 491.683 468.867C490.123 476.5 507.341 508.045 515.5 522.5C523.5 532.5 564.972 575.719 559.395 595.748Z" fill="#C4C4C4"/>
        <animated.path style={animatedHands} d="M559.395 595.748C554.934 611.77 529.812 608.509 517.809 604.876C460.498 593.51 379.8 520.795 346.615 485.859C302.937 439.867 340.561 373.193 364.833 345.604C380.512 355.958 375.004 376.878 370.29 386.044C361.586 405.476 359.196 430.815 359.09 441.056C401.183 504.57 444.502 504.214 460.899 496.097C458.91 455.75 462.338 413.419 475.277 420.264C488.215 427.11 494.096 457.064 491.683 468.867C490.123 476.5 507.341 508.045 515.5 522.5C523.5 532.5 564.972 575.719 559.395 595.748Z" fill="url(#paint5_linear)"/>
        <animated.path style={animatedHands} d="M828.289 297.116C832.06 285.503 831.586 266.472 830.877 258.408L853.844 260.055L858.228 301.026C848.518 334.97 830.671 351.252 822.962 355.15C806.959 344.899 823.575 311.631 828.289 297.116Z" fill="#C4C4C4"/>
        <animated.path style={animatedHands} d="M828.289 297.116C832.06 285.503 831.586 266.472 830.877 258.408L853.844 260.055L858.228 301.026C848.518 334.97 830.671 351.252 822.962 355.15C806.959 344.899 823.575 311.631 828.289 297.116Z" fill="url(#paint6_linear)"/>
        <animated.path style={animatedHands} d="M848.105 328.695C855.232 306.75 850.453 281.781 847.172 272.039L878.375 282.173C876.62 307.42 869.751 363.042 856.32 383.546C839.531 409.176 829.063 387.329 830.548 382.757L848.105 328.695Z" fill="#C4C4C4"/>
        <animated.path style={animatedHands} d="M848.105 328.695C855.232 306.75 850.453 281.781 847.172 272.039L878.375 282.173C876.62 307.42 869.751 363.042 856.32 383.546C839.531 409.176 829.063 387.329 830.548 382.757L848.105 328.695Z" fill="url(#paint7_linear)"/>
        <animated.path style={animatedHands} d="M855.404 402.707C858.298 391.618 867.05 326.255 871.064 294.96L893.923 302.384C896.822 316.803 898.136 354.773 880.208 391.304C862.28 427.834 856.202 414.127 855.404 402.707Z" fill="#C4C4C4"/>
        <animated.path style={animatedHands} d="M855.404 402.707C858.298 391.618 867.05 326.255 871.064 294.96L893.923 302.384C896.822 316.803 898.136 354.773 880.208 391.304C862.28 427.834 856.202 414.127 855.404 402.707Z" fill="url(#paint8_linear)"/>
        <animated.path style={animatedHands} d="M693.626 154.243C698.763 138.424 723.724 142.748 735.563 146.888C792.34 160.677 869.877 236.752 901.549 273.066C943.236 320.87 902.815 385.887 877.394 412.42C862.168 401.411 868.56 380.743 873.659 371.786C883.179 352.741 886.643 327.526 887.184 317.299C847.825 252.055 804.53 250.571 787.803 257.985C788.078 298.38 782.855 340.528 770.219 333.139C757.583 325.75 752.979 295.573 755.891 283.884C758.22 274.532 743.727 242.618 736.189 227.83C724.218 218.003 687.205 174.016 693.626 154.243Z" fill="#C4C4C4"/>
